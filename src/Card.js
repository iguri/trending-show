        ...
        <div className="movie">
          ...
          <div className="text-movie-cont">
            <div className="mr-grid">
              <div className="col1">
                ...
                <ul className="movie-gen">
                  <li>{props.isAdult ? "PG-13/" : null}</li>
                  <li>{props.relase},</li>
            ...
            <div className="mr-grid action-row">
              <div className="col2" onClick={()=>openModal(props.videoId)}><div className="watch-btn"><h4><i className="material-icons">&#xE037;</i>WATCH TRAILER</h4></div>
              </div>
